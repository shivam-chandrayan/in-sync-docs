...
import { ImageUploadButton } from "src/components/tiptap-ui/image-upload-button";
import { ListDropdownMenu } from "src/components/tiptap-ui/list-dropdown-menu";
...
} from "src/components/tiptap-ui/color-highlight-popover";
import {
  LinkPopover,
  LinkContent,
  LinkButton,
} from "src/components/tiptap-ui/link-popover";
import { MarkButton } from "src/components/tiptap-ui/mark-button";
...
export function SimpleEditor() {
  ...
  // Get overlay height from ref after component mounts
  useEffect(() => {
